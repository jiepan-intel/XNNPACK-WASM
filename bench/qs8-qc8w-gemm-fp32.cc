...
#include <xnnpack/microparams-init.h>
...
#if XNN_ENABLE_AVX512AMX && (XNN_ARCH_X86 || XNN_ARCH_X86_64)
  static void qs8_qc8w_gemm_minmax_fp32_ukernel_16x16c4__avx512amx_acc2(benchmark::State& state, const char* net) {
    GEMMBenchmark(state,
      xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_16x16c4__avx512amx_acc2,
      xnn_init_qs8_qc8w_conv_minmax_fp32_avx512_params,
      xnn_pack_qs8_gemm_goi_w,
      /*mr=*/16, /*nr=*/16, /*kr=*/4, /*sr=*/1,
      benchmark::utils::CheckAVX512AMX);
  ...
  BENCHMARK_GEMM(qs8_qc8w_gemm_minmax_fp32_ukernel_16x16c4__avx512amx_acc2)
#endif  // XNN_ENABLE_AVX512AMX && (XNN_ARCH_X86 || XNN_ARCH_X86_64)
